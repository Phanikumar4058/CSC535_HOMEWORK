...
public class BlackJackProgramming {
	String type;
	int currentcard;
	int total =0;
	...
	public BlackJackProgramming(String Player){
		 type =Player;
	...
	{
		BlackJackProgramming Phani = new BlackJackProgramming("Phani");
		BlackJackProgramming dealer = new BlackJackProgramming("dealer");
		Phani.winner();
	}
}